...
export class Draw {
    ...
    DrawText(text, x, y, maxWidth) {
        this.style == this.TYPES.STROKED ? this.screen.Context.strokeText(text, x, y, maxWidth) : this.screen.Context.fillText(text, x, y, maxWidth); 
    }
    ...
    DrawRect(x, y, width, height) {
        ...
        this.style == this.TYPES.STROKED ? this.screen.Context.strokeRect(x, y, width, height) : this.screen.Context.fillRect(x, y, width, height);
    }
    ...
    DrawCircle(x, y, radius) {
        ...
        this.style == this.TYPES.STROKED ? this.screen.Context.stroke() : this.screen.Context.fill();
    }
